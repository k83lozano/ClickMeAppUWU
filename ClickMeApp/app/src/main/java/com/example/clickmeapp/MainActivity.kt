...
class MainActivity : AppCompatActivity() {
    private var textView: TextView? = null
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            val ButtSave: Button = findViewById<Button>(R.id.savebutton)
            val ButtClean: Button = findViewById<Button>(R.id.clearbutton)
            ...
            ButtSave?.setOnClickListener(object :View.OnClickListener {
